...
#include "webrtc/examples/android/Collaboration_Voice/jni/voice_engine_jni.h"

#include <map>
#include <string>

#include "webrtc/examples/android/Collaboration_Voice/jni/jni_helpers.h"
...
#define JOWW(rettype, name)                                             \
  extern "C" rettype JNIEXPORT JNICALL Java_com_goldsand_collaboration_voice_##name
...
static const char* g_classes[] = {"com/goldsand/collaboration/voice/CodecInst"};
...
JOWW(jobject, VoiceEngine_getCodec)(JNIEnv* jni, jobject j_voe, jint index) {
  ...
  jclass j_codec_class = GetClass(jni, "com/goldsand/collaboration/voice/CodecInst");
